...
fn main() -> Result<()> {
    ...
    let answer = match args.problem {
        ...
        31 => problems::p0031::solve()?,
        35 => problems::p0035::solve()?,
        36 => problems::p0036::solve()?,
        37 => problems::p0037::solve()?,
        38 => problems::p0038::solve()?,
        39 => problems::p0039::solve()?,
        40 => problems::p0040::solve()?,
        43 => problems::p0043::solve()?,
        44 => problems::p0044::solve()?,
        45 => problems::p0045::solve()?,
        46 => problems::p0046::solve()?,
        _ => {
